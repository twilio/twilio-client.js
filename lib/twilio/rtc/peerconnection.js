...
function PeerConnection(audioHelper, pstream, getUserMedia, options) {
  ...
  this.onicedisconnect = noop;
  this.onicefailure = noop;
  this.onicereconnect = noop;
