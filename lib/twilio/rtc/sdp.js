...
/**
 * Make sure proper CRLF is added
 * https://www.rfc-editor.org/rfc/rfc4566#section-5
 * https://groups.google.com/g/discuss-webrtc/c/CEG0odmqlCo
 * https://bugs.chromium.org/p/chromium/issues/detail?id=414395&thanks=414395&ts=1410809385
 */
function ensureTrailingCRLF(sdp) {
  if(!/[\r\n]$/.test(sdp)) {
    return sdp + '\r\n';
  }
  return sdp;
...
function setCodecPreferences(sdp, preferredCodecs) {
  ...
  return ensureTrailingCRLF([session].concat(mediaSections.map(section => {
