...
RTCPC.prototype.processSDP = function(maxAverageBitrate, codecPreferences, sdp, constraints, onSuccess, onError) {
  ...
  console.log('xxxxxxx processSDP', JSON.stringify(desc));
...
RTCPC.prototype.processAnswer = function(codecPreferences, sdp, onSuccess, onError) {
  ...
  console.log('xxxxxxx processAnswer', JSON.stringify(desc));
  return promisifySet(this.pc.setRemoteDescription, this.pc)(desc).then(onSuccess, onError);
};
