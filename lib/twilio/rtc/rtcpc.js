...
function RTCPC() {
  if (typeof window === 'undefined') {
    this.logger.info('No RTCPeerConnection implementation available. The window object was not found.');
    return;
  }
  ...
  if (util.isEdge()) {
    ...
    this.logger.info('No RTCPeerConnection implementation available');
  }
}
